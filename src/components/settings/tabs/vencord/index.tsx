    ...
    return (
        <SettingsTab>
            ...
            <QuickActionCard>
                ...
                />
                {user && isAnyPluginDev(user.id) && (
                    <QuickAction
                        Icon={GithubIcon}
                        text="Your Contributions"
                        action={() => openContributorModal(user)}
                    />
                )}
            </QuickActionCard>
            ...
            <Paragraph className={Margins.bottom16}>
                Manage custom CSS, window behavior, and desktop controls.
            </Paragraph>
            <Notice.Info className={Margins.bottom20} style={{ width: "100%" }}>
                Change where Protonn Cord appears in Discord's settings menu with the{" "}
                <TextButton
                    variant="link"
...
export default wrapTab(ProtonnCordSettings, "Protonn Cord Settings");
